...
// source reference: https://github.com/Learus/react-material-ui-carousel
...
function Indicators(props) {
  ...
  for (let i = 0; i < props.length; i++) {
    ...
    const activeStyle =
      props.activeIndicatorProps !== undefined ? props.activeIndicatorProps.style : undefined
    const activeClassName =
      props.activeIndicatorProps !== undefined ? props.activeIndicatorProps.className : undefined
  ...
  const wrapperStyle =
    props.indicatorContainerProps !== undefined ? props.indicatorContainerProps.style : undefined
  const wrapperClassName =
    props.indicatorContainerProps !== undefined ? props.indicatorContainerProps.className : ''
